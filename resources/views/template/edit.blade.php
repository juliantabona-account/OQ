                ...
                <div class="col-12 col-lg-8 col-md-8 grid-margin offset-1 stretch-card mb-2">
                    <div class="card">
                        <div class="card-body pb-2">
                            <h3 class="float-left">Edit Jobcard Template</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body pb-2">
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb breadcrumb-custom pt-2 mb-2">
                                    <li data-toggle="tooltip" data-placement="top" title="" class="breadcrumb-item progress-status-tabs selected clickable-row" data-href="{{ route('jobcard.processForm.create.step2', [$processForm->id]) }}" data-target="#exampleModal-1" data-original-title="Define template name, description, category, e.t.c">
                                        <span>General</span>
                                    </li>
                ...
                <div class="col-12 col-lg-8 col-md-8 grid-margin offset-1 stretch-card">
                    <div class="card card-hoverable">
                        <div class="card-body p-3 pt-4">
                            <form method="POST" action="{{ route('jobcard.processForm.update', [$processForm->id]) }}">
                                {{ method_field('PUT') }}
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input data-toggle="tooltip" data-placement="top" title="Template name/title"
                                                           type="text" id="name" name="name" placeholder="Enter template name..." value="{{ old('name', $processForm->name) }}" class="form-control{{ $errors->has('name') ? '  is-invalid' : '' }}" required autocomplete="false">
                                                    @if ($errors->has('name'))
                                        ...
                                        <button type="submit" class="btn btn-primary pr-2 pr-3 float-right">
                                            Update
                                        </button>
                                    </div>
                                </div>
