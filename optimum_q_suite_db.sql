...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2018 at 06:34 AM
...
--
-- Table structure for table `company_contractors`
--
...
--
-- Dumping data for table `company_contractors`
--
...
--
-- Table structure for table `jobcard_contractors`
--
...
--
-- Dumping data for table `jobcard_contractors`
--
...
--
-- Table structure for table `process_form_allocation`
--
...
--
-- Dumping data for table `process_form_allocation`
--
...
--
-- Table structure for table `process_form_field_allocation`
--
...
--
-- Dumping data for table `process_form_field_allocation`
--
...
--
-- Table structure for table `process_form_responses`
--
...
--
-- Dumping data for table `process_form_responses`
--
...
--
-- Table structure for table `process_form_steps`
--
...
--
-- Dumping data for table `process_form_steps`
--
...
--
-- Table structure for table `process_form_step_allocation`
--
...
--
-- Dumping data for table `process_form_step_allocation`
--
...
--
-- Indexes for table `company_contractors`
--
...
--
-- Indexes for table `jobcard_contractors`
--
...
--
-- Indexes for table `process_form`
--
ALTER TABLE `process_form`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `process_form_allocation`
--
ALTER TABLE `process_form_allocation`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `process_form_fields`
--
ALTER TABLE `process_form_fields`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `process_form_field_allocation`
--
ALTER TABLE `process_form_field_allocation`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `process_form_responses`
--
ALTER TABLE `process_form_responses`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `process_form_steps`
--
ALTER TABLE `process_form_steps`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `process_form_step_allocation`
--
...
--
-- AUTO_INCREMENT for table `company_contractors`
--
ALTER TABLE `company_contractors`
...
--
-- AUTO_INCREMENT for table `jobcard_contractors`
--
ALTER TABLE `jobcard_contractors`
...
--
-- AUTO_INCREMENT for table `process_form`
--
ALTER TABLE `process_form`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `process_form_allocation`
--
ALTER TABLE `process_form_allocation`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `process_form_fields`
--
ALTER TABLE `process_form_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `process_form_field_allocation`
--
ALTER TABLE `process_form_field_allocation`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `process_form_responses`
--
ALTER TABLE `process_form_responses`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `process_form_steps`
--
ALTER TABLE `process_form_steps`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `process_form_step_allocation`
--
ALTER TABLE `process_form_step_allocation`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
